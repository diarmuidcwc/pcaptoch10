...
# -*- coding: utf-8 -*-
"""
Converts a pcap file to a ch10 file
"""
...
logging.getLogger("AcraNetwork.IRIG106.Chapter11").setLevel(logging.CRITICAL)
            ...
            for idx, record in enumerate(pf):
                ...
                if len(eth_pkt) > CH10_DATA_OFFSET + CH10_DATA_LEN_MIN:
                    ...
                    try:
                        ...
                        if got_time_packet is None:
                            if ch10_pkt.datatype == DataType.TIMEFORMAT_1 or ch10_pkt.datatype == DataType.TIMEFORMAT_2:
                                got_time_packet = True
                                tmats_ch10 = encapsulate_tmats(args.tmats, 0)
                        ...
                        if got_time_packet:
                            ...
                            ch10file.write(new_ch10_pkt.pack())
